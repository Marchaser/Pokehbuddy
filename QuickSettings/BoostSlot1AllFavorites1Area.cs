...
{  // BoostPetSlot1Ringer
    public partial class configForm
    {
        public void BoostSlot1AllFavorites1AreaInit()
        {
            ...
            Pokehbuddy.quicksettingdesc.Add("Enables GatherBuddy2, and manages the settings." + System.Environment.NewLine + "YOU have to load a profile to your liking. " + System.Environment.NewLine + System.Environment.NewLine + "Will swapout the lowlevel when its level 25 and swap in a new FAVORITE pet of level 1+");
